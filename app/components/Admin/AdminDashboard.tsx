    ...
    >
      ...
      <Grid container spacing={isMobile ? 2 : 3} sx={{ mb: 4 }}>
        {[
          ...
          <Grid item xs={12} sm={6} md={6} key={index} sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems:'center' }}
          >
            <Card
              sx={{
                flex: 1,
      ...
      <Grid container spacing={isTablet ? 2 : 3} sx={{ mb: 4 }}>
        <Grid item xs={12} md={6} sx={{ display: 'flex', justifyContent: 'space-evenly', alignItems:'center' }}>
          <Card
            sx={{
              flex: 1,
