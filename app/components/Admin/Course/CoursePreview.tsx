...
const CoursePreview: React.FC<Props> = ({
  ...
  return (
    ...
    >
      <div className={`w-full py-6 ${isDark ? "bg-gray-800" : "bg-white"} shadow-md`}>
        <div className="w-[90%] max-w-7xl mx-auto">
          ...
          >
            {isEdit ? "Update Course Preview" : "Course Preview"}
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            {isEdit ? "Review your changes before updating" : "Review your course before publishing"}
          </motion.p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div
                  className={`flex items-center gap-2 p-3 rounded-lg ${isDark ? "bg-gray-700" : "bg-gray-100"
                    }`}
                >
            ...
            <div className="lg:col-span-1">
              <div
                className={`p-6 rounded-xl shadow-lg sticky top-6 ${isDark ? "bg-gray-700" : "bg-white border border-gray-200"
                  }`}
              >
                {thumbnailUrl && (
                ...
                {/* Course Features */}
                <div
                  className={`space-y-3 text-sm mb-6 ${isDark ? "text-gray-300" : "text-gray-600"
                    }`}
                >
                  <div className="flex items-center gap-2">
                ...
                {/* Guarantee */}
                <div
                  className={`text-center text-sm mb-6 p-3 rounded-lg ${isDark
          ...
          {courseContent.length > 0 && (
            <div className="mt-12 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={handleBack}
                  className={`w-full py-3 px-4 rounded-lg font-medium ${isDark
